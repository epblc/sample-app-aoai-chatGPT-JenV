                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h1 className={styles.chatEmptyStateTitle}>Welkom bij Vera!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Jouw Virtuele & IntelligEnte Rijksoverheid Assistente, vraag me alles wat je wil weten</h2>
                            </Stack>
                        ) : (
